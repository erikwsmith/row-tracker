    ...
    return (
        <>
            <Link to={`/projects/${project._id}`}
                ...
                border-4 border-solid border-[#db5ccc]'
            >
                <div className='card-body'>
                    ...
                    <div className='card-actions justify-between items-center mt-4'>
                        <span className='text-sm text-base-content/60'>{formatDate(new Date(project.createdAt))}</span>
                        <div className='flex items-center gap-1'>
                            <PenSquareIcon className='size-4'/>
                            <button className='btn btn-ghost btn-xs text-error' onClick={(e)=> handleDelete(e, project._id)}>
